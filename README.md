...
![Internet Censorship Explained - Computerphile](artefact1.png)
...
![Two teens have launched a High Court challenge to the under-16s social media ban](artefact2.png)
...
![Social media, expression, and online engagement - Frontiers in Communication](artefact3.png)
...
![Week 9 workshop attendance](workshop-selfie.jpg)
...
Before this week, I thought about censorship mainly as governments blocking websites they did not like, a fairly simple idea. What I learnt in Workshop 9 was that censorship works through many different mechanisms, technical, legal, and commercial, and that even a well-intentioned law can go badly wrong in practice.

The case study that stood out to me most was the ASIC and Section 313 case, where the Australian Securities and Investments Commission ordered an ISP to block a single scam website, but because the block was applied at the IP address level rather than the domain level, it accidentally took down around 250,000 unrelated websites that shared the same IP address. This connects directly to my first artefact, the Computerphile video, which explains that IP-based blocking cannot distinguish between different websites hosted on the same server. Seeing this happen in a real Australian case made the technical limitation feel much more serious than just a theoretical weakness.

This case also shaped my view on who should regulate internet content. I think government regulation is still necessary, because governments are at least accountable through courts and elections, but the ASIC case shows that this power needs proper technical oversight before it is used, otherwise the damage can be worse than the original problem. Leaving regulation entirely to private companies is not better either, since companies like Meta answer mainly to shareholders, not the public, which is the concern raised in my third artefact about the "chilling effect."

As a cybersecurity student, this week connected directly to what I am studying. Learning exactly how DNS-based blocking, IP-based blocking and firewall rules work, and how they can be bypassed using VPNs and Tor, is not just background knowledge, it is the same technical understanding used in penetration testing and network security. This workshop made me see censorship not only as an ethical and legal issue, but as a technical problem, where a badly configured block, like in the ASIC case, can create real security and availability failures.

This connects to Kantianism and Act Utilitarianism, which we studied in an earlier week. Both Kant and Mill opposed censorship in principle, but Mill's Harm Principle allows some restriction when there is a risk of harm to others. The ASIC case shows the opposite problem, a restriction that was meant to prevent harm ended up causing harm to thousands of innocent websites, which made me think that intention alone does not make censorship ethical, the method matters just as much.

### Justification on why I chose the artefact

I chose to reflect on the ASIC and Section 313 case because it was the moment in the workshop that changed how I think about government censorship. Before this, I assumed government-ordered blocking was mostly precise and well controlled, since it is done through official legal channels. Learning that a single IP block could accidentally take down 250,000 websites showed me that even legally justified censorship can fail badly without proper technical safeguards, which is directly relevant to my studies in cybersecurity.
